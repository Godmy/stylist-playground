...
<div class="presets-panel space-y-4 p-4">
  ...
  >
    ...
    <ul class="text-xs text-orange-800 dark:text-orange-400 space-y-1">
      <li>в­ђ Star presets to mark them as favorites</li>
      <li>рџ”ў Usage count shows how often you use each preset</li>
      <li>рџ“‹ Duplicate presets to create variations</li>
    </ul>
  </div>
</div>
