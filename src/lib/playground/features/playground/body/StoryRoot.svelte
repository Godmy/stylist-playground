<script lang="ts">
  ...
  import { registerShortcut, initKeyboardShortcuts, deinitKeyboardShortcuts, ShortcutHelpers } from '../../../utils/keyboard';
  import Navigator from '../manager/Navigator.svelte';
  import Canvas from './Canvas.svelte';
  import PlaygroundToolbar from '../header/PlaygroundToolbar.svelte';
  ...
  onMount(() => {
    ...
    registerShortcut(ShortcutHelpers.searchStories(() => {
      playgroundStore.setSearchQuery('');
    }));
